...
import { AttributeStories } from "./subcomponents/Stories/Stories.js";
import { AttributePost } from "./subcomponents/Post/Post.js";
export class Home extends HTMLElement {
    ...
    render() {
        ...
        if (this.shadowRoot) {
            ...
            (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(storiesContainer);
